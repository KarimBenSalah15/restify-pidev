...
public class HomeController {
    ...
    public void initialize() {
        ...
        productGridPane.add(historiqueReclamationButton, 1, 0);
        PlatCompo = new Button("Plat Surprise");
        PlatCompo.setOnAction(this::openHistoriqueReclamationScene2);
        productGridPane.add(PlatCompo, 0, 0);
    ...
    private void openHistoriqueReclamationScene(ActionEvent actionEvent) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/AffComm2.fxml"));
    ...
    private void openHistoriqueReclamationScene2(ActionEvent actionEvent) {
        try {
