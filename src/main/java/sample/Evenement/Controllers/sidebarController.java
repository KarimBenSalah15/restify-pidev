...
public class sidebarController {
    ...
    private void loadStocksSearch() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/sample/Evenement/Evenement.fxml"));
    ...
    void methodeStock(MouseEvent event) {
        System.out.println("Clic sur le label Evenement");
        loadPage("/sample/productsearch/Evenement.fxml");
    }
    @FXML
    void methodeProduit(MouseEvent event) {

        loadPage("/sample/Evenement/Evenement.fxml");
    }
    @FXML
    void methodEvent(MouseEvent event) {
        System.out.println("Clic sur le label Evenement");
        loadPage("/sample/Evenement/Evenement.fxml");
    }
