...
public class NavbarEmp {
    ...
    private void loadCommandeFXML() {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/sample/projectfinder/commande.fxml"));
        try {
    ...
    private void affichagetableau2() {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/sample/projectfinder/commandeTraiter.fxml"));
        try {
