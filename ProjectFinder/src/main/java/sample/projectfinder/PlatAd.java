...
public class PlatAd {
    ...
    public void add(ActionEvent actionEvent) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/sample/projectfinder/FirstWindow.fxml"));
    ...
    private void openModifPlatPage(Plat plat) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/sample/projectfinder/ModifPlat.fxml"));
            Parent root = loader.load();
